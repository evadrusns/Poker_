...
La fonction '''public static carte tirage()''' permet de générer une carte aléatoirement grâce au '''Random()'''. Cela crée la structure de la carte avec deux
paramètres : valeur et famille.
